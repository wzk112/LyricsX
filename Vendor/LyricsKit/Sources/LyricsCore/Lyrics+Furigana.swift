...
extension LyricsLine {
    fileprivate mutating func generateFurigana() {
...
extension CFStringTokenizer {
    fileprivate func currentFuriganaAnnotation(in string: String) -> (String, Range<String.Index>)? {
...
extension CharacterSet {
    fileprivate static let hiragana = CharacterSet(charactersIn: "\u{3040}" ..< "\u{30a0}")
    fileprivate static let katakana = CharacterSet(charactersIn: "\u{30a0}" ..< "\u{3100}")
    fileprivate static let kana = CharacterSet(charactersIn: "\u{3040}" ..< "\u{3100}")
    fileprivate static let kanji = CharacterSet(charactersIn: "\u{4e00}" ..< "\u{9fc0}")
}
