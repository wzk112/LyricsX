...
- 主窗口与悬浮窗使用柔和的弹性歌词切换，配合少量模糊、逐字高亮和响应式布局；支持“减少动态效果”。
...
从 [Releases](https://github.com/wzk112/LyricsX/releases) 下载最新的 `LyricsX-2.0.11.zip`，解压后将 `LyricsX.app` 拖到 `/Applications`。
...
完整的安装、签名和版本说明见 [`docs/releases/v2.0.11.md`](docs/releases/v2.0.11.md)。
