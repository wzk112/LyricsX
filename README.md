...
从 [Releases](https://github.com/wzk112/LyricsX/releases) 下载最新的 `LyricsX-2.0.21.zip`，解压后将 `LyricsX.app` 拖到 `/Applications`。
...
完整的安装、签名和版本说明见 [`docs/releases/v2.0.21.md`](docs/releases/v2.0.21.md)。
